...
($head,$clk,$cc,$ccb,$gl,$kt,$hko,$lfs,$np,$pc,$sk,$sc,$st,$sko,$stanley,$sf,$tkl,$tmt,$tpk,$tmo,$tc,$two,$ty,$tm,$wl,$wp,$wch) = split(/\n/, $wind);
#Chek Lap Kok, Cheung Chau, Cheung Chau Beach, Green Island, Kai Tak, King's Park, Lau Fau Shan, Ngong Ping, Peng Chau, Sai Kung, Sha Chau, Sha Tin, Shek Kong, Sha Chau, Stanley, Star Ferry, Ta Kwu Ling, Tai Mei Tuk, Tai Po Kau, Tap Mun, Tate's Cairn, Tseung Kwan O, Tsing Yi, Tuen Mun, Waglan Island, Wetland Park, Wong Chuk Hang
# 赤立角,長洲,長洲灘,青洲,啟德,京士柏,流浮山,昂平,坪洲,西貢,沙州,沙田,石崗,赤柱,天星碼頭,打鼓嶺,大尾篤,大埔坳,塔門,大老山,將軍澳,青衣,屯門,橫蘭,濕地公園,黃竹坑
